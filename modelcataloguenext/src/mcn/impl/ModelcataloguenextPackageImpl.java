 ...
 * @generated
 */
public class ModelcataloguenextPackageImpl extends EPackageImpl implements ModelcataloguenextPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see mcn.ModelcataloguenextPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ModelcataloguenextPackageImpl() {
		super(eNS_URI, ModelcataloguenextFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ModelcataloguenextPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ModelcataloguenextPackage init() {
		if (isInited) return (ModelcataloguenextPackage)EPackage.Registry.INSTANCE.getEPackage(ModelcataloguenextPackage.eNS_URI);

		// Obtain or create and register package
		ModelcataloguenextPackageImpl theModelcataloguenextPackage = (ModelcataloguenextPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ModelcataloguenextPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ModelcataloguenextPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theModelcataloguenextPackage.createPackageContents();

		// Initialize created meta-data
		theModelcataloguenextPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theModelcataloguenextPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ModelcataloguenextPackage.eNS_URI, theModelcataloguenextPackage);
		return theModelcataloguenextPackage;
	}
	 ...
	 * @generated
	 */
	public ModelcataloguenextFactory getModelcataloguenextFactory() {
		return (ModelcataloguenextFactory)getEFactoryInstance();
	}

...
public class FTuple_PrimitiveType2EObjectPrimitiveType8 implements Rule<FTuple,EObject>{
	...
	public boolean check(FTuple source){
		...
		return source.instanceOf( ((ModelGenerator4Mcn)source.getInstance().getMetaModel()).get_PrimitiveType() );
	}

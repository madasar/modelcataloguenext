...
public class FTuple_DataClass2EObjectDataClass4 implements Rule<FTuple,EObject>{
	...
	public boolean check(FTuple source){
		...
		return source.instanceOf( ((ModelGenerator4Mcn)source.getInstance().getMetaModel()).get_DataClass() );
	}
	...
	public void setProperties(EObject target, FTuple source, Transformer t){
		...
		EStructuralFeature feature3 = objectClass3.getEStructuralFeature("contains");
				
		List<FTuple> linkFTuples3 = source.getInstance().getTuples("get_contains_DataClass_to_DataClass_contains");
		...
		EStructuralFeature feature5 = objectClass5.getEStructuralFeature("label");
				
		List<FTuple> linkFTuples5 = source.getInstance().getTuples("get_label_CatalogueElement_to_CatalogueElement_label");
		List<FTuple> dataFTuples5 = source.getInstance().getTuples("get_CatalogueElement_label"); 
		...
		EStructuralFeature feature6 = objectClass6.getEStructuralFeature("extends");
				
		List<FTuple> linkFTuples6 = source.getInstance().getTuples("get_extends_DataClass_to_DataClass_extends");
		List<FTuple> dataFTuples6 = source.getInstance().getTuples("get_DataClass"); 
		...
		EStructuralFeature feature8 = objectClass8.getEStructuralFeature("defines");
				
		List<FTuple> linkFTuples8 = source.getInstance().getTuples("get_defines_DataClass_to_DataClass_defines");
		List<FTuple> dataFTuples8 = source.getInstance().getTuples("get_DataItem"); 

...
public class DataConstraintImpl extends MinimalEObjectImpl.Container implements DataConstraint {
	...
	protected EClass eStaticClass() {
		return McnPackage.Literals.DATA_CONSTRAINT;
	}
	...
	public void setLanguage(String newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, McnPackage.DATA_CONSTRAINT__LANGUAGE, oldLanguage, language));
	}

...
public class FTuple_Enumeration2EObjectEnumeration9 implements Rule<FTuple,EObject>{
	...
	public boolean check(FTuple source){
		...
		return source.instanceOf( ((ModelGenerator4Mcn)source.getInstance().getMetaModel()).get_Enumeration() );
	}
	...
	public void setProperties(EObject target, FTuple source, Transformer t){
		...
		EStructuralFeature feature6 = objectClass6.getEStructuralFeature("OrderedValues");
				
		List<FTuple> linkFTuples6 = source.getInstance().getTuples("get_OrderedValues_Enumeration_to_Enumeration_OrderedValues");
		List<FTuple> dataFTuples6 = source.getInstance().getTuples("get_EnumValue"); 

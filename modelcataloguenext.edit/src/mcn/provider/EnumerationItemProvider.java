...
/**
 * This is the item provider adapter for a {@link mcn.Enumeration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Enumeration_enums_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Enumeration_enums_feature", "_UI_Enumeration_type"),
				 McnPackage.Literals.ENUMERATION__ENUMS,
				 true,
				 false,
				 true,
				 null,

...
public class FTuple_DataType2EObjectDataType6 implements Rule<FTuple,EObject>{
	...
	public boolean check(FTuple source){
		...
		//check the FTuple is a tuple of the get_DataType relation 
		return source.instanceOf( ((ModelGenerator4Mcn)source.getInstance().getMetaModel()).get_DataType() );
	}
	...
	public EObject build(FTuple source, Transformer t){
		...
		EClass metaClass = (EClass) metaModel.getEObject( "//DataType" );

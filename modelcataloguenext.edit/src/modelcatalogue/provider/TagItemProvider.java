...
public class TagItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 McnPackage.Literals.TAG__LABEL,
				 true,
				 false,
				 false,
	...
	protected void addURIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tag_URI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tag_URI_feature", "_UI_Tag_type"),
				 McnPackage.Literals.TAG__URI,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Tag.class)) {
			case McnPackage.TAG__LABEL:
			case McnPackage.TAG__URI:
